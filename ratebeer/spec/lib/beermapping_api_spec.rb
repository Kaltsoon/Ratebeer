...
describe "BeermappingAPI" do
  ...
  it "when HTTP GET returns no entry, it is parsed and returned" do
    s = <<-END_OF_STRING
  ...
  it "when HTTP GET returns multiple, it is parsed and returned" do 
    s = <<-END_OF_STRING
