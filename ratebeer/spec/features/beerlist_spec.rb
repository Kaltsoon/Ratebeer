...
describe "Beerlist page" do
  ...
  it "shows beers in alphabetical by default", js: true do
    visit beerlist_path
  ...
  it "shows beers in alphabetical order of its style after clicking style link", js: true do
    visit beerlist_path
    click_link("Style")
  ...
  it "shows beers in alphabetical order of its brewery after clicking brewery link", js: true do
    visit beerlist_path
    click_link("Brewery")
